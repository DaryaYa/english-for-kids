...
export const cards = [
  ['Action SET A', 'Action SET B', 'Action SET C', 'Adjective', 'Animals SET A', 'Animals SET B', 'Clothes', 'Emotions'],
  [
    {
      word: 'cry',
      translation: 'плакать',
  ...
  [
    {
      ...
      audioSrc: 'src/assets/src/assets/audio/cat.mp3',
    },
    {
      word: 'chick',
      translation: 'цыплёнок',
      image: 'src/assets/src/assets/img/chick.jpg',
      audioSrc: 'src/assets/src/assets/audio/chick.mp3',
    },
    {
      word: 'chicken',
      translation: 'курица',
      image: 'src/assets/src/assets/img/chicken.jpg',
      audioSrc: 'src/assets/src/assets/audio/chicken.mp3',
    },
    {
      word: 'dog',
      translation: 'собака',
      image: 'src/assets/src/assets/img/dog.jpg',
      audioSrc: 'src/assets/src/assets/audio/dog.mp3',
    },
    {
      word: 'horse',
      translation: 'лошадь',
